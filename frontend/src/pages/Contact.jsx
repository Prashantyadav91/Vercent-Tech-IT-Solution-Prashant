...
const Contact = () => {
  ...
  return (
    <div className="mt-16 md:mt-19 bg-gray-100">
      ...
      <div className="flex flex-col">
        <motion.div
          ...
          className="flex mx-auto flex-col gap-5 text-center p-5">
          <h1 className="mt-5 text-4xl font-semibold">Get in Touch</h1>
        ...
        <div className="flex flex-col md:flex-row items-start justify-center gap-10 p-5 md:p-15">
          <motion.div
            ...
            transition={{ duration: 0.9, ease: 'easeOut' }}
            viewport={{ once: false, amount: 0.2 }}
            className="overflow flex flex-col gap-5 md:gap-10 w-full md:w-[45%]">
          ...
          <div className="flex flex-col gap-2 w-full md:w-[40%] px-auto">
            ...
            <form className="flex flex-col gap-5 w-full md:w-[90%] mt-2" action="">
              ...
              <motion.button
                ...
                transition={{ duration: 0.9, ease: 'easeOut' }}
                viewport={{ once: false, amount: 0.2 }}
                className=" border-2 font-bold text-xl bg-blue-400 text-white w-50 p-2 cursor-pointer" onClick={handleSubmit} type="button">
                Submit
              </motion.button>
            </form>
          </div>
