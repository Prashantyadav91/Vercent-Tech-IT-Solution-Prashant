    ...
    <div className='mt-15 md:mt-20 bg-gray-100'>
      ...
      <div className='w-full p-3'>
        <div className='my-10 bg-blue-400 text-white p-10 flex items-center flex-col gap-7 w-ful md:w-[80%] mx-auto rounded-xl'>
          ...
          <p className='text-center text-xl'>Send your resume and portfolio to <u><b>yadavshashank9@gmail.com</b></u> and take the next step in your IT career.</p>
          <a className='bg-white text-blue-700 py-3 px-5 rounded-lg text-xl font-semibold' href="mailto:yadavshashank9@gmail.com">Apply Today</a>
        </div>
      </div>
