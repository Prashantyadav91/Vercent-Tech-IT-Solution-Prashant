...
const About = () => {
  ...
  return (
    <div className='h-auto mt-20 md:mt-25'>
      <div className='w-full bg-gray-100'>
        <div className='flex flex-col items-center gap-8 p-3 md:p-5 w-full md:w-[80%] mx-auto'>
          <h1 className='text-4xl font-semibold'>About VERCENT</h1>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center gap-15 p-3 md:p-10 bg-gray-100'>
        <div className='shadow-custom rounded-4xl p-5 bg-white'>
      ...
      <div className='p-5'>
        <div className='w-full md:w-[77%] flex flex-col gap-7 mx-auto text-center bg-blue-100 px-2 md:px-30 py-10 md:py-15 rounded-3xl shadow-custom  md:my-20'>
      ...
      <div className='flex flex-col items-center mt-10 md:mt-0 bg-gray-100 py-5'>
        <h1 className='text-4xl font-semibold px-3 text-center'>What Our Clients Says</h1>
        <div className='my-10 w-full md:w-[80%] px-3 flex flex-col gap-10 md:gap-0 md:flex-row justify-between'>

          <div className='w-full md:w-[45%] shadow-custom p-3 md:p-5 rounded-2xl flex flex-col gap-3 bg-white'>
